...
const tests=[
 ...
 ['supervision',{typeId:'supervision_indicator',headers:['بنود التقويم','المتوسط'],rows:[{'بنود التقويم':'تخطيط المنهاج لتحقيق نواتج التعلم','المتوسط':3.5},{'بنود التقويم':'فاعلية إدارة الصف','المتوسط':2.1},{'بنود التقويم':'توظيف استراتيجيات التدريس','المتوسط':2.8},{'بنود التقويم':'توظيف أساليب تقويم متنوعة','المتوسط':1.9},{'بنود التقويم':'التطوير المهني وتحسين الأداء','المتوسط':3.2}],scoreColumn:'المتوسط',maxScore:4}],
 ['studentwork',{typeId:'student_work',headers:['بنود التقويم','المتوسط','الأكثر تكرارا'],rows:[{'بنود التقويم':'يحقق الطلبة تقدما دراسيا في الأعمال','المتوسط':2,'الأكثر تكرارا':2},{'بنود التقويم':'يقدم المعلم تغذية راجعة فعالة','المتوسط':1,'الأكثر تكرارا':1},{'بنود التقويم':'تنمي الأنشطة مهارات التعلم الرقمي','المتوسط':2,'الأكثر تكرارا':2},{'بنود التقويم':'يراعي المعلم التمايز بين الطلبة','المتوسط':1,'الأكثر تكرارا':1}],scoreColumn:'المتوسط',maxScore:2}],
