...
fs.writeFileSync(path.join(root,'docs','taqareer_v0_9_2_segmented_deep_analysis_preview.html'),html);
fs.writeFileSync(path.join(root,'tests','fixtures','segmented-deep-analysis-v092.json'),JSON.stringify(reconciled,null,2));
